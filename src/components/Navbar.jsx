...
import { Search, ShoppingCartOutlined, Menu, Close, ExpandMore } from "@material-ui/icons";
import styled, { keyframes } from "styled-components";
import { Link } from "react-router-dom";
import Announcement from "./Announcement";
import Ediprofile from "../Videos/Mr.Botwe.jpg"
...
const Navbar = () => {
  ...
  const drawerContent = (
    ...
    >
      ...
      <Link to="/ServicePage"> < AnimatedButton> Our Service</AnimatedButton> </Link>
      <Link to="/AboutPage"> < AnimatedButton>About us</AnimatedButton> </Link>
      <Link to="/ContactPage"> < AnimatedButton>Contact us</AnimatedButton> </Link>
      <Link to="/FAQPage"> < AnimatedButton>FAQ</AnimatedButton> </Link>
...
//       </Link>
//       <Link to="/AboutPage">
//         <AnimatedButton>About us</AnimatedButton>
//       </Link>
//     </div>
//   );
